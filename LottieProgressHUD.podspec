#
#  Be sure to run `pod spec lint LottieProgressHUD.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Wipoo Shinsirikul" => "749739+mylifeasdog@users.noreply.github.com" }
  # Or just: s.author    = "Wipoo Shinsirikul"
  # s.authors            = { "Wipoo Shinsirikul" => "749739+mylifeasdog@users.noreply.github.com" }
  # s.social_media_url   = "http://twitter.com/Wipoo Shinsirikul"
